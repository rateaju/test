    ...
    <div class="container">
        ...
        <ul class="pager">
                ...
                if($page <=1){
                    ...
                    echo "<li><a href='index.php?page=1'>처음</a></li>";
                }
                if($page <=1){
                    echo "";
                } else {
                    $pre = $page -1;
                    echo "<li><a href='index.php?page=$pre'>이전</a></li>";
                }
                ...
                if($page >= $count){
                    ...
                    $next = $page +1;
                    echo "<li><a href='index.php?page={$next}'>다음</a></li>";
                }
                if($page >= $count){
                    echo "";
                    ...
                    $next = $count;
                    echo "<li><a href='index.php?page={$count}'>마지막</a></li>";
                }
                /*
                for($i = 1; $i<=$count ; $i++){
